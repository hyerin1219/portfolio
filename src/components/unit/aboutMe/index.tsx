        ...
        <section className="w-full h-auto ">
            ...
            <div className="w-full  p-6 border-4  border-[#5A93FF]  bg-[#F7FAFF]  rounded-xl  shadow-[6px_6px_0_0_#A9D8FF] ">
                <div className="flex items-center justify-center gap-3 mb-6 p-3  bg-[#FFE38F] rounded-xl text-xl shadow-[3px_3px_0_0_#FFC824]">
                    ...
                    <span className="sm:text-xl font-bold text-lg text-center">모험가 정혜린</span>
                </div>

                <div className="text-justify sm:text-lg mb-6 space-y-4">
                    <p>안녕하세요. 사용자 경험을 중심으로 생각하며, 키보드에서 손을 떼지 않을 때 가장 몰입하는 정혜린입니다.</p>
                    <p>지난 2년간 웹 퍼블리셔로 근무하며 HTML, CSS, JavaScript기반 사내 템플릿을 활용해 기능 적용 및 커스텀, 기능 제안 및 적용하여 디지털 교과서 콘텐츠를 제작했습니다. 이 과정에서 재사용 가능한 컴포넌트 설계, 구조화된 레이아웃 구성, 프로젝트 일정 관리 및 팀원과의 협업 경험을 쌓았습니다.</p>
                    <p>현재는 React와 TypeScript를 중심으로 개인 및 팀 프로젝트를 제작한 경험을 통해, 상태 관리, UI 인터랙션, 사용자 흐름을 고려한 기능 구현을 동시에 고민하고 있습니다. 단순히 화면을 만드는 것을 넘어, 사용자가 편리하게 사용할 수 있는 인터페이스와 안정적인 구조를 설계하는 개발자로 성장하고자 합니다.</p>
                </div>
